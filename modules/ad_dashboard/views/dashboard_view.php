...
<div id="dashboard" class="content no-padding">
    <div class="row">
        ...
        <?php /* <div class="col-lg-4 col-md-6 col-sm-12 col-xs-12">
        ...
        <div class="col-lg-4 col-md-6 col-sm-12 col-xs-12">
            <div class="small-box bg-yellow">
                <div class="inner das-inner">
                    <div class="col-lg-12">
                        <img class="sub-menu-item-icon" src="<?php echo $dot_icon; ?>">
                        <a class="das-link addNewTsmsData " href="<?php echo base_url('admin/accounts'); ?>">Danh sách người dùng.</a>
                    </div>
                </div>
                <div class="icon">
                ...
                <a  href="#" class="small-box-footer das-title">
                    NGƯỜI DÙNG  <i class="fa fa-arrow-circle-right"></i>
                </a>
            </div>
        </div><!-- ./col -->
