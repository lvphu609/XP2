        ...
        <div class="panel-heading">
            <div class="pull-right">
                <div class="row">
                    <div class="col-lg-12">
                        <div class="pull-right">
                            <button type="submit" form="form-category" data-toggle="tooltip" title="Lưu" class="btn btn-success btn-save-post-type" data-original-title="Save"><i class="fa fa-save"></i></button>
