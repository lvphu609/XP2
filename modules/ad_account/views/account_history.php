    ...
    <div class="panel-heading">
        ...
        <div class="pull-right">
            <a href="<?php echo base_url('admin/accounts'); ?>">
                <button title="Trở lại" type="button" class="btn btn-default btn-sm col-xs-12 button-add">
        ...
        <div class="dataTable_wrapper table-responsive">
            <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                ...
                <tr>
                    ...
                    <th width="25%" class="text-center" colspan="2">Loại yêu cầu</th>
                    <th width="49%" class="text-center">Nội dung lịch sử hoạt động</th>
