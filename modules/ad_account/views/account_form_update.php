...
?>
    ...
    <form id="formUpdateAccount" action="<?php echo base_url('admin/accounts/update'); ?>" method="post">
        <input type="hidden" value="<?php echo $account_info['id']; ?>" name="id">
        <div class="panel panel-default">
            ...
            <div class="panel-footer">
                <span class="pull-right">
                    ...
                    <a href="<?php echo base_url('admin/accounts'); ?>" data-original-title="Edit this user" data-toggle="tooltip" type="button" class="btn btn-sm btn-default"><i class="glyphicon glyphicon-edit"></i> Hủy</a>
                </span>
                <div class="clear"></div>
            </div>
        </div>
